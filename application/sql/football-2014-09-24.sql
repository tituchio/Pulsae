...
-- Dumping structure for table football.permalink
DROP TABLE IF EXISTS `permalink`;
CREATE TABLE IF NOT EXISTS `permalink` (
  `per_id` int(11) NOT NULL AUTO_INCREMENT,
  `per_url` varchar(256) DEFAULT NULL,
  `per_shorturl` varchar(64) DEFAULT NULL,
  `per_pic` varchar(256) DEFAULT NULL,
  `per_media` varchar(32) DEFAULT NULL,
  `per_text` text,
  PRIMARY KEY (`per_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table football.permalink: ~0 rows (approximately)
...
-- Dumping data for table football.setting: ~5 rows (approximately)
...
INSERT INTO `setting` (`key`, `val`) VALUES
	...
	('left_menu', '[{"url":"http:\\/\\/www.akimitechnologies.com\\/","label":"DEVELOPED BY AKIMI TECHNOLOGIES"}]'),
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
	(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1411485415, 1, 'Admin', 'istrator', 'ADMIN', '0');
